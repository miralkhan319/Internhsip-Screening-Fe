...
function Profile() {
    ...
    useEffect(() => {
        axios.get('/users/getUpdateStudentProfile', {
            headers: {
            ...
            .then((res) => {
                ...
                setDegree(res.data.student.degree.title);
                setVuid(res.data.student.vuid);
                setCnic(res.data.student.cnic);
    ...
    const postData = async () => {
        try {
            const response = await axios.patch("/users/studentProfile", formData, {
                headers: {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        postData();
        console.log([phone, fullname, logo])
    }
