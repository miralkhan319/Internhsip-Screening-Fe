...
const resultofjoinned = () => {
  ...
  useEffect(() => {
    axios.get(`/student_registrations/view_PassoutStudent/${id}`, {
      headers: {
...
<div class="border-t border-gray-200 px-4 py-5 sm:p-0">
  ...
  <div className=" flex justify-center items-center   mt-5 md:gap-16  sm:gap-64 gap-2">
            <Link href={"/students/passoutlist"}>
              <button className=" w-28 h-10 hover:border  font-serif  text-white bg-[#445279]  hover:border-blue-400  hover:text-black rounded-xl  hover:scale-110 hover:bg-[#002c7424]  duration-300">OK</button></Link></div>
